...
// {
//     printf("\n🚫 Ctrl+C is disabled! You pressed SIGINT (signal number: %d)\n", signum);
//     printf("Use 'exit' command or Ctrl+D to quit.\n");
// }
...
void list_all_commands()
{
    ...
    // printf("  history      - Show previously executed commands\n");
    // printf("  exit         - Exit the Shell-Z terminal\n");

    // printf("\n>> Shell-Z Exclusive Commands:\n");
    // printf("  listcmds     - Show all available commands\n");
    // printf("  showteam     - Display Shell-Z team contributors\n");
    // printf("  help         - Detailed guide for Shell-Z usage\n");
    // printf("  runscript    - Execute predefined automation scripts\n");
    // printf("  aiassist     - Interact with built-in AI assistant\n");
    // printf("  launchhttp   - Start Nexis HTTP Server\n");
    // printf("  schedsim     - Launch process scheduling simulator\n");
    // printf("  devmode      - Enable developer mode for advanced logs\n");
    // printf("  showlog      - View recent log entries\n");
}

/* Method to show a detailed guide about Shell-Z. Guide about the purpose
of existing commands and additional commands too, also guide the user regarding
the features of Shell-Z. about how to interact with AI, how to use add-ons that Shell-Z
offers and more. */
void help()
{
    clear();
...
void list_comrades()
{
    ...
    // gotoxy(45 + strlen(" Meet the Comrades! "), 14);
...
void alpha_exit()
{
    ...
    printf("\t\t");
    animate("Interested in contributing? Check out the GitHub Repository: \033[1;34mhttps://github.com/AyeshaJaved04/Shell-Z\033[1;34\n", 40, 1, 32);
